# -*- coding: utf-8 -*-
"""Модели базы данных для системы email-рассылок."""
...
class Mailing(models.Model):
    ...
    subject = models.CharField(
        max_length=200, verbose_name="Тема"
    )
...
class MailingLog(models.Model):
    ...
    opened_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Дата открытия"
    )
    ...
    def __str__(self):
        return "{} - {}".format(
            self.mailing.subject, self.subscriber.email
        )
